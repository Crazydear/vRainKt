...
data class BookConfigData(
    val title: String="",
    val author: String = "",
    val canvas_id: CanvasConfigData,            //古籍刻本背景图ID
    val row_num: Int = 35,                      //每列字数
    val row_delta_y: Float = 8f,                //列最后字符到边框距离
    val multirows_horizontal_layout: Int? = null,
    //字体
    val font1: String = "qiji-combo.ttf",
    ...
    //正文字体大小、颜色
    val text_fonts_array: String = "123",
    val text_font1_size: Float = 45f,
    val text_font2_size: Float = 40f,
    val text_font3_size: Float = 40f,
    val text_font4_size: Float = 40f,
    val text_font5_size: Float = 40f,
    val text_font_color: String = "black",

    //批注字体大小、颜色
    val comment_fonts_array: String ="123",
    val comment_font1_size: Float = 25f,
    val comment_font2_size: Float = 20f,
    val comment_font3_size: Float = 20f,
    val comment_font4_size: Float = 20f,
    val comment_font5_size: Float = 20f,
    ...
    val title_font_size: Float = 80f,
    val title_font_color: String = "black",
    val title_y: Float = 1200f,
    val title_ydis: Float = 1.2f,
    val title_postfix: String? = null,  //版心标题后缀，X会自动替换，若存在保存前言、序的000.txt文件，将自动更新为序，若存在保存后记、附录的999.txt文件，将自动更新为附，不需要后缀时置空即可
    val title_directory: Int = 0,       //根据标题自动添加PDF目录

    //版心页码字体大小、颜色、高度
    val pager_font_size: Float = 30f,
    val pager_font_color: String = "black",
    val pager_y: Float = 480f,
...
class AncientBookState(initialData: BookConfigData) {
    ...
    var canvasId: CanvasConfigData            //古籍刻本背景图ID
    ...
    var multirowsHorizontalLayout: Boolean
        get() = configData.multirows_horizontal_layout == 1
        set(value) { configData = configData.copy(multirows_horizontal_layout = if (value) 1 else null) }
    ...
    //正文字体大小、颜色
    val textFonts_array: String = "123"
    ...
    //批注字体大小、颜色
    val commentFontsArray: String ="123"
